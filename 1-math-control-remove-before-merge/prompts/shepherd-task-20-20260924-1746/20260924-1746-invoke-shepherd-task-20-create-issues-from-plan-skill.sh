#!/usr/bin/env bash
set -euo pipefail
timestamp=20260924-1746
log_dir_full=/home/edburns/workareas/dd-3068633-linux-x64-04-shepherd-control/1-math-control-remove-before-merge/prompts/shepherd-task-20-20260924-1746
...
prompt_file=/home/edburns/workareas/dd-3068633-linux-x64-04-shepherd-control/1-math-control-remove-before-merge/prompts/shepherd-task-20-20260924-1746/20260924-1746-invoke-shepherd-task-20-create-issues-from-plan-skill.md
